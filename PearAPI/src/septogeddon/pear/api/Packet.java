...
public abstract class Packet implements Serializable {
	 ...
	 * @return the same packet but released some unused resources before sending to another peer
	...
	/***
	 * Handle conversion from Packet {@link MODE_CLIENT_TO_SERVER} to Packet {@link MODE_SERVER_TO_CLIENT}
	 * @return the packet instance
	 */
